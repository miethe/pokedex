...
from .models import BasePokemon, BaseSpecies, GenerationInfo, TypeInfo
...
# Add functions to fetch lists? Maybe less ideal for a simple library
# async def get_all_pokemon_list(...)
# async def get_all_generations_list(...)